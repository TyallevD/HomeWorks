...
//        System.out.println();
        ...
        //8. Парсинг массива //todo доделать
        ...
        /*
         * есть массив строк, нужно перевести в двумерный массив символов
         * вывести двумерный массив (можно будет удалить)
         * сравнить значения из двумерного массива с диапазоном от 48 до 57 включительно
         * */
        //метод преобразования массива строк в двумерный массив символов
        char[][] chars = new char[strings.length][];
        for (int i = 0; i < chars.length; i++) {
            chars[i] = strings[i].toCharArray();
        }
        //вывод двумерного массива строк(можно убрать)
        for (int i = 0; i < chars.length; i++) {
        ...
        //метод создания двумерного массива чисел из строк и вывод на экран (можно разделить на пару методов)
