package ru.java413.homework15.controllers;

import ru.java413.homework15.entities.Person;
import ru.java413.homework15.projection.LastNameCountProjection;
import ru.java413.homework15.projection.PersonCitiesProjection;
import ru.java413.homework15.services.CityService;
import ru.java413.homework15.services.PersonService;
...
public class MainController {
    ...
    @Operation(
            operationId = "7",
            summary = "Задание 1.7. Метод, который возвращает все записи с несколькими сортировками (по age и lastName)"
    )
