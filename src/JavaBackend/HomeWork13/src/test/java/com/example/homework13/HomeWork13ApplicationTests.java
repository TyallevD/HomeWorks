...
class HomeWork13ApplicationTests {
    ...
    // Напишите тесты для создания книги с валидными данными, получения книги по существующему ID, получения книги по несуществующему ID (должен возвращать 404).

    //Задание 2: Тестирование валидации данных
    //Протестируйте валидацию при создании книги.
    // Напишите тесты для: создания книги с пустым title (должен возвращать 400),
    ...
    // Протестируйте: полное обновление существующей книги, обновление несуществующей книги (404),
    // частичное обновление книги (PATCH), обновление с невалидными данными (400).
